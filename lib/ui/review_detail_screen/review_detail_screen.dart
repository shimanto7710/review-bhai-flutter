...
import 'package:reviewbahi/ui/review_detail_screen/bloc/review_detail_bloc.dart';
import 'package:reviewbahi/ui/review_detail_screen/bloc/review_detail_state.dart';

class ReviewDetailScreen extends StatefulWidget {
  static const routeName = '/reviewDetailScreen';
...
class _ReviewDetailScreenState extends State<ReviewDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   elevation: 2,
      // ),
      body: BlocProvider<ReviewDetailBloc>(
        create: (_) => _bloc,
        // ignore: missing_return
        child: BlocConsumer<ReviewDetailBloc, ReviewDetailState>(
            listener: (BuildContext context, ReviewDetailState state) {
          // ignore: missing_return
        },
            // ignore: missing_return
            builder: (BuildContext context, ReviewDetailState state) {
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return _foodItem(context, index);
                            },
                          ),
                        ),
                        Container(
  ...
  Widget _foodItem(BuildContext context, int index) {
    return Container(
        margin: EdgeInsets.only(top: 20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Container(
              ...
              child: Wrap(
                children: [
                  Text(("#pathao_buy_1_get_1")),
                  Text(("#best_kacchi_in_town")),
                  Text(("#250tk_free_offer")),
                  Text(("#pathao_buy_1_get_1")),
                ],
              ),
            )
