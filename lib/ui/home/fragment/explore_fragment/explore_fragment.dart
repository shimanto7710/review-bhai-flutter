...
class _ExploreFragmentState extends State<ExploreFragment> {
  ...
  void initState() {
    ...
    _foodList.add(FoodModel("f1", 0xffFFC0BF, "All"));
    _foodList.add(FoodModel("f2", 0xffFCECCF, "Burger"));
    _foodList.add(FoodModel("f3", 0xffCEEED1, "Coffee"));
    _foodList.add(FoodModel("f4", 0xffF4D8B6, "Drinks"));
    _foodList.add(FoodModel("f5", 0xffFFE7F2, "Pizza"));
    _foodList.add(FoodModel("f6", 0xffDAF7FF, "Pasta"));
    _foodList.add(FoodModel("f2", 0xffFCECCF, "Burger"));
    _foodList.add(FoodModel("f3", 0xffCEEED1, "Coffee"));
    _foodList.add(FoodModel("f4", 0xffF4D8B6, "Drinks"));
    _foodList.add(FoodModel("f6", 0xffDAF7FF, "Pasta"));
            ...
            Container(
              ...
              child: Wrap(
                children: [
                  Text(" 4.5",
                      style:
                          TextStyle(fontSize: 12, color: CustomColors.fontDark)),
                  Container(
                  ...
                  Container(
                    ...
                    child: Text("(12 rating)",
                        style:
                            TextStyle(fontSize: 12, color: CustomColors.fontLight)),
                  ),
                ],
              ),
            ),
...
class FoodModel {
  ...
  FoodModel(this._url, this._color, this._name);
}
